...
exports.manufacturerValidator = [ // Validation pour le fabriquant
  validate({
    validator: 'isLength',
    arguments: [3, 40], // Fabriquant doit contenir entre 3 et 40 caratères
    message: 'Le nom du fabricant doit contenir entre 3 et 40 caractères',
  }),
  validate({
    validator: 'matches',
    arguments: /^[a-z\d\-_\s]+$/i, // Regex pour restreindre le type de symboles pour le fabriquant
